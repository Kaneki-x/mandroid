...
/// Handles `androidrunner://` URLs.
///
/// - `androidrunner://launch/<package>` opens (or focuses) an app window
/// - `androidrunner://device` shows the device screen
/// - `androidrunner://library` shows the library
///
/// Debug builds add `androidrunner://debug/...` hooks used by
...
struct URLSchemeHandler {
    ...
    func handle(_ url: URL) {
        guard url.scheme == "androidrunner" else { return }
        let host = url.host ?? ""
